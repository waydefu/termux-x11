...
M = [
 ...
 ('b3_attribution.py', 'complete = all_complete or (no_fatal and c0 is not None and len(ev5) == c0)',
  'complete = True', 'test_b3_attribution.py', 'T.test_incomplete_events_null_every_cell'),
 ('b3_attribution.py', 'complete = all_complete or (no_fatal and c0 is not None and len(ev5) == c0)',
  'complete = all_complete', 'test_b3_attribution.py', 'T.test_non_direct_line_lost_still_attributes'),
 ('b3_attribution.py', 'complete = all_complete or (no_fatal and c0 is not None and len(ev5) == c0)',
  'complete = all_complete or (c0 is not None and len(ev5) == c0)', 'test_b3_attribution.py', 'T.test_fatal_disables_the_c0_rule'),
 ('b3_attribution.py', 'if complete and disjoint else None', 'if complete else None',
  'test_b3_attribution.py', 'T.test_touching_windows_null_every_cell'),
